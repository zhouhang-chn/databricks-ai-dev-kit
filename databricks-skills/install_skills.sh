...
get_skill_description() {
    case "$1" in
        ...
        "databricks-scenario-onboarding") echo "Prepare analysis scenarios: project settings, requirements, resource gaps, Metric Views, validation" ;;
