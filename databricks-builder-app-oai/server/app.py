"""FastAPI app for the OpenAI Agents SDK Builder application."""
...
from .services.mlflow_setup import setup_mlflow_tracing
...
async def lifespan(app: FastAPI):
  ...
  # Configure MLflow tracing for the OpenAI Agents SDK if MLFLOW_EXPERIMENT_NAME is set
...
app = FastAPI(
  title='OpenAI Agents SDK Builder App',
  description='Project-based OpenAI agent application for Databricks workflows',
  lifespan=lifespan,
)
